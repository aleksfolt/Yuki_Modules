...
def register_module(app: Client):
    @app.on_message(filters.create(is_owner) & filters.command("movie", prefixes=prefix_userbot))
    ...
    @app.on_message(filters.create(is_owner) & filters.command("omdb_set_key", prefixes=prefix_userbot))
