...
def register_module(app: Client):
    @app.on_message(filters.create(is_owner) & filters.command("weather_set_key", prefixes=prefix_userbot))
    ...
    @app.on_message(filters.create(is_owner) & filters.command("weather", prefixes=prefix_userbot))
